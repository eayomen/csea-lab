...
for fileindex = 1:size(filemat,1)
    ...
    load('/Users/estelleayomen/Documents/GitHub/csea-lab/Libas/4data/HCGSNSensorPostionFiles/GSN-HydroCel-32.sfp.mat');
    ...
    [ mat_std, badindex, NGoodtrials ] = scadsAK_3dtrials(mat_std_tmp, 1.5); 
    [ mat_target, badindex, NGoodtrials ] = scadsAK_3dtrials(mat_target_tmp, 1.5); 
